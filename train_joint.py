...
if __name__ == "__main__":
    ...
    parser.add_argument("--test_iterations", nargs="+", type=int, default=[500, 800, 1000, 2000, 3000, 4000, 5000, 10000, 20000, 40000, 80000, 120000, 160000])
    parser.add_argument("--save_iterations", nargs="+", type=int, default=[5000, 10000, 20000, 40000, 80000, 120000, 160000])
